    ...
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="http://localhost/lab7/Donor_register.php">Register as an oxygen cylinder provider</a></li>
        </ul>
...
<br> <br> <br> <br>
<div style='margin-left:70px'><h4>Looking for oxygen cylinder? Enter your preffered location to find oxygen cylinder provider near you.</h4>
...
if(isset($_POST['search'])){
  ...
  $T=$_POST['Thana'];
  if($T==null){
  $query1 = "SELECT * FROM oxygen WHERE District='$D' && Available ='Yes'";
  }
  else{
  $query1 = "SELECT * FROM oxygen WHERE  District='$D' && Thana='$T'";
  }
  ...
  if($result1->num_rows>0){
    ...
    <input type="text"style=margin-bottom:30px name="House_no"size="15" value="<?php echo $row['House_Number']  ?>">
    </form>
    <?php
    }
  }
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-info">
            <h3>About Medica</h3>
            <p>It’s a website that is dedicated for emergency medical information and medical purpose. It will provide information during medical emergency situation, like in need of ICU, ambulanc
